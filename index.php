...
$meta_data['instance-type'] = $instance_type = exec($curl_cmd." http://".$meta_host."/latest/meta-data/instance-type/");
...
<div id="page-container">
    ...
    <div id="sidebar-a">
        <div class="padding">
            ...
            <h3>Instance Type</h3>
            <p><?php echo $meta_data['instance-type']; ?></p><br>
            <h3>Information</h3>
